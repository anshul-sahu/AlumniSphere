...
public class InternshipController {
	...
	@GetMapping("/get_student_applied_intern/{userId}")
	public ResponseEntity<ApiResponse> getStudentAppliedIntern(@PathVariable Integer userId){
		List<StudentInternshipStatusDto> res =  internServ.collectStudentStatus(userId);
		
		return new ResponseEntity<>(new ApiResponse(true, "successful", res), HttpStatus.OK);
	}
