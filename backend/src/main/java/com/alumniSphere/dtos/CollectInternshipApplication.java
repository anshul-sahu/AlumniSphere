...
public class CollectInternshipApplication {
	...
	private List<StudentInternshipApplicationDto> internApp;
	
	
	public List<StudentInternshipApplicationDto> getInternApp() {
		return internApp;
	}
	public void setInternApp(List<StudentInternshipApplicationDto> internApp) {
