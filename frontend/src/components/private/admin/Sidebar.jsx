...
const sidebarItems = [
  { label: "Dashboard", to: "/admin/dashboard", icon: GraduationCap },
  { label: "Alumni", to: "/admin/alumni", icon: GraduationCap },
  { label: "Students", to: "/admin/students", icon: Users },
  { label: "Other Admins", to: "/admin/admins", icon: ShieldCheck },
  { label: "Events", to: "/admin/events", icon: CalendarDays },
  { label: "View Profile", to: "/admin/profile", icon: UserCircle2 },
  { label: "Internships", to: "/admin/internships", icon: Briefcase },
  { label: "Mentorship", to: "/admin/mentorship", icon: UserSquare2 }
];
